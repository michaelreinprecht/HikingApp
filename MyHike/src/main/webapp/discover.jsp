...
<script>
  function addPOI() {
    ...
    let poiFileInput = document.getElementById('poiImage');
    let poiFile = poiFileInput.files[0];
    let poiImageSource;
    if (poiFile) { //Get source to display image.
    ...
    $.ajax({
      ...
      data: { data: poiTitle, poiDescription, poiLon, poiLan, poiImageSource },
